...
public class AlbumAdapter extends RecyclerView.Adapter<AlbumAdapter.ViewHolder> {
    ...
    public AlbumAdapter(Context context, OnPopularFragmentInteractionListener listener) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onAlbumClick(holder.mItem);
                }
            }
        });
    ...
    public void addAll(List<Album> items) {
